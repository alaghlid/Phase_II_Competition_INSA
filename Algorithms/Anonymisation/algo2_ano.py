...
def alanozy_ano():
    ...
    ## Suppression des Ids satisfaisant la régle suivante : index % 3 == 0  => Pourcentage de suppression : 40% ( 4 lignes dans chaque bloc de 10 Lignes )
    ...
    df[gps] = df[gps].round(5) + 0.000055
